...
public class CustomList {
	 ...
	 * size by 1.
	 * @param text specifies word inside the node
	 */
	public void addFront(String text) {
		Node temp = new Node();
		temp.word = new Word(text);
		temp.next = head;
		head = temp;
		size++;
	}
	/*
	 * Retrieves the word of the node in the nth location
	...
	/*
	 * Changes the word within the nth node to text
	 * @param text the new word
